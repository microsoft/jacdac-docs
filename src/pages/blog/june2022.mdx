...
We are delighted to announce the public debut of Microsoft Research’s [Jacdac](https://aka.ms/jacdac) platform 
for plug-and-play creation and programming of physical computing systems. 
Jacdac brings three exciting enhancements to [MakeCode for the micro:bit](https://makecode.microbit.org/):

1.	[modular accessories](#modular-accesories) with plug-and-play cables – Jacdac kit available from Kittenbot;
2.	[unified block coding](#unified-block-coding-for-accessories) for all accessories; and
...
Jacdac has been designed so that it can be used with existing micro:bit accessories. For example, the Kitronik Air Quality and Environmental Board for micro:bit pictured to the right can be described by six Jacdac services that cover the set of sensors/features of the board: temperature, air pressure, humidity, equivalent CO₂, real time clock and character screen. 

We have created Jacdac-versions of extensions for a variety of micro:bit accessories. Let’s load the Jacdac extension for the Kitronik board into MakeCode. 
...
-	**Jacdac kits avaible**: see the [device catalog](/devices)!
