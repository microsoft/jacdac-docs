...
The easiest way to learn about Jacdac is through the [device dashboard](/dashboard),
which allows you spin up simulators for most of the Jacdac [services](/services):
...
If you visit the [service catalog](/services) and click the `Simulator`
icon, the services that have simulator support will be listed:
