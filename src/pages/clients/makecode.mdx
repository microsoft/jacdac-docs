...
<Video label="Connect to a physical micro:bit" src="connectmicrobit" />
...
<Video label="Add Jacdac button extension in MakeCode" src="addmodule" />
...
<Video label="Add Jacdac button extension from simulator" src="addbutton" />
