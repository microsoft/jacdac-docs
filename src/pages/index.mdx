...
* Learn more about [service specifications](/reference/specification/service-specification/)
...
* Learn more about [device definitions](/reference/specification/device-definition/)
