...
self.__precacheManifest = [
  {
    "url": "webpack-runtime-b305151a431dff708225.js"
  },
  {
  ...
  },
  {
    ...
    "revision": "fdc7cec88beba826ff763c681d8916f9"
  },
  {
...
const navigationRoute = new NavigationRoute(async ({ event }) => {
  ...
  if (!resources || !(await caches.match(`/jacdac-docs/app-67f8eb1a7ff8fc9cf2b4.js`))) {
    return await fetch(event.request)
  }
