...
self.__precacheManifest = [
  {
    "url": "webpack-runtime-0b702692fdac1852e305.js"
  },
  {
  ...
  },
  {
    ...
    "revision": "2223234368720217b5725fc28b0b4c94"
  },
  {
...
const navigationRoute = new NavigationRoute(async ({ event }) => {
  ...
  if (!resources || !(await caches.match(`/jacdac-docs/app-90f294995a6f55e2193b.js`))) {
    return await fetch(event.request)
  }
