...
self.__precacheManifest = [
  {
    "url": "webpack-runtime-976793dba1fe9625045d.js"
  },
  {
  ...
  },
  {
    ...
    "revision": "6de2d1d25490e8bf437e14f170832b1c"
  },
  {
...
const navigationRoute = new NavigationRoute(async ({ event }) => {
  ...
  if (!resources || !(await caches.match(`/jacdac-docs/app-705ef7dbbf6bb245916e.js`))) {
    return await fetch(event.request)
  }
