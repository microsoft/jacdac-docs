...
self.__precacheManifest = [
  {
    "url": "webpack-runtime-0be80110666fe7e0f630.js"
  },
  {
  ...
  },
  {
    ...
    "revision": "a440ef5116621fefd9297eddefc8c528"
  },
  {
...
const navigationRoute = new NavigationRoute(async ({ event }) => {
  ...
  if (!resources || !(await caches.match(`/jacdac-docs/app-ab951e5b7ccd6a5f0fc2.js`))) {
    return await fetch(event.request)
  }
