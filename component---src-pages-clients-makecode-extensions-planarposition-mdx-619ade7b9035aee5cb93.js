...
function _createMdxContent(props) {
  ...
  }, "{\"source\":\"let x = 0\\nlet minX = 0\\nlet frequency = 0\\nbasic.forever(function () {\\n    x = modules.planarPosition1.x()\\n    minX = Math.min(x, minX)\\n    frequency = 1000 + (x - minX) * 20\\n    if (frequency > 0) {\\n        music.playTone(frequency, 20)\\n    }\\n})\",\"rendered\":{\"req\":{\"code\":\"let x = 0\\nlet minX = 0\\nlet frequency = 0\\nbasic.forever(function () {\\n    x = modules.planarPosition1.x()\\n    minX = Math.min(x, minX)\\n    frequency = 1000 + (x - minX) * 20\\n    if (frequency > 0) {\\n        music.playTone(frequency, 20)\\n    }\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac-planar-position=github:microsoft/pxt-jacdac/planar-position#v1.9.28\"},\"type\":\"renderblocks\",\"id\":\"b5ce90e57f3f1ec2586ca936a3b63329\"},\"url\":\"/images/makecode/b5ce90e57f3f1ec2586ca936a3b63329.png\"}}\n")), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(MakeCodeExtensionFooter, {
...
//# sourceMappingURL=component---src-pages-clients-makecode-extensions-planarposition-mdx-619ade7b9035aee5cb93.js.map