...
function _createMdxContent(props) {
  ...
  }, "{\"source\":\"basic.forever(function () {\\n    let dx = modules.gamepad1.x()\\n    let dy = modules.gamepad1.y()\\n    if (Math.abs(dx) > 20 || Math.abs(dy) > 20) {\\n        modules.hidMouse1.move(dx / 4, dy / 4)\\n    }\\n})\",\"rendered\":{\"req\":{\"code\":\"basic.forever(function () {\\n    let dx = modules.gamepad1.x()\\n    let dy = modules.gamepad1.y()\\n    if (Math.abs(dx) > 20 || Math.abs(dy) > 20) {\\n        modules.hidMouse1.move(dx / 4, dy / 4)\\n    }\\n})\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac-gamepad=github:microsoft/pxt-jacdac/gamepad#v1.9.28,jacdac-hid-mouse=github:microsoft/pxt-jacdac/hid-mouse#v1.9.28\"},\"type\":\"renderblocks\",\"id\":\"5e2a51e19ce53ce1ec1e4d627fb79949\"},\"url\":\"/images/makecode/5e2a51e19ce53ce1ec1e4d627fb79949.png\"}}\n")), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(MakeCodeProjectFooter, {
...
//# sourceMappingURL=component---src-pages-clients-makecode-projects-gamepad-mouse-mdx-bd6ca651f99446b05f47.js.map