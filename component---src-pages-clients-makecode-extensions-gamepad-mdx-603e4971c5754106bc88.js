...
function _createMdxContent(props) {
  ...
  }, "{\"source\":\"basic.forever(() => {\\n    plot(modules.gamepad1.x(), modules.gamepad1.y())\\n})\\n\\nfunction plot(x: number, y: number) {\\n        basic.clearScreen();\\n        let dispX = 2;\\n        let dispY = 2;\\n        if (x < -30)\\n            dispX--;\\n        if (x < -60)\\n            dispX--;\\n        if (x > 30)\\n            dispX++;\\n        if (x > 60)\\n            dispX++;\\n        if (y < -30)\\n            dispY--;\\n        if (y < -60)\\n            dispY--;\\n        if (y > 30)\\n            dispY++;\\n        if (y > 60)\\n            dispY++;\\n        led.plot(dispX, dispY);\\n}\\n\",\"rendered\":{\"req\":{\"code\":\"basic.forever(() => {\\n    plot(modules.gamepad1.x(), modules.gamepad1.y())\\n})\\n\\nfunction plot(x: number, y: number) {\\n        basic.clearScreen();\\n        let dispX = 2;\\n        let dispY = 2;\\n        if (x < -30)\\n            dispX--;\\n        if (x < -60)\\n            dispX--;\\n        if (x > 30)\\n            dispX++;\\n        if (x > 60)\\n            dispX++;\\n        if (y < -30)\\n            dispY--;\\n        if (y < -60)\\n            dispY--;\\n        if (y > 30)\\n            dispY++;\\n        if (y > 60)\\n            dispY++;\\n        led.plot(dispX, dispY);\\n}\\n\",\"options\":{\"pixelDensity\":1,\"package\":\"jacdac-gamepad=github:microsoft/pxt-jacdac/gamepad#v1.9.27\"},\"type\":\"renderblocks\",\"id\":\"b7c8fa803c0a6824841e523f0a74427f\"},\"url\":\"/images/makecode/b7c8fa803c0a6824841e523f0a74427f.png\"}}\n")), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_components.h2, {
    id: "events",
    style: {
      position: "relative"
    }
...
//# sourceMappingURL=component---src-pages-clients-makecode-extensions-gamepad-mdx-603e4971c5754106bc88.js.map